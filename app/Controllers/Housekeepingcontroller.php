    ...
    public function addNewLocation(){
        ...
        if($_POST){
            ...
            if($this->validate($rules)){
                ...
                $location->save($data);
              $alert = array(
                'msg' => 'Success! New location added',
                'type' => 'success',
                'location' => site_url('/locations')
              );
        ...
        if($_POST){
            $rules = [
                ...
                if($this->validate($rules)){
                    ...
                    $bank->update($this->request->getVar('bankId'), $data);
                  $alert = array(
                    'msg' => 'Success! Changes saved.',
                    'type' => 'success',
                    'location' => site_url('/banks')
                  );
                  return view('pages/sweet-alert', $alert);
    ...
    public function updateDepartment(){
        ...
        if($_POST){
            ...
            if($this->validate($rules)){
                ...
                $department->update($this->request->getVar('departmentId'), $data);
              $alert = array(
                'msg' => 'Success! Changes saved.',
                'type' => 'success',
                'location' => site_url('/departments')
              );
              return view('pages/sweet-alert', $alert);
