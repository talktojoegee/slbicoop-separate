...
$routes->post('/update-bank', 'Housekeepingcontroller::updateBank');
...
$routes->post('/update-department', 'Housekeepingcontroller::updateDepartment');
...
$routes->get('/edit-chart-of-account/(:num)', 'ChartOfAccountController::showEditChartOfAccount/$1');
$routes->post('/delete-chart-of-account', 'ChartOfAccountController::deleteChartOfAccount');
$routes->post('/update-chart-of-account', 'ChartOfAccountController::updateChartOfAccount');
#Report routes
...
$routes->get('/third-party/setup-vendor', 'PaymentController::setupVendor');
$routes->post('/third-party/setup-vendor', 'PaymentController::postVendorSetup');
$routes->get('/third-party/manage-vendors', 'PaymentController::getVendors');
