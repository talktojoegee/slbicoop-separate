...
<!--                                </li>-->
                                ...
                                <li>
                                    ...
                                    <ul>
                                      ...
                                      <li class="header"><b>Vendor</b></li>
                                      <li><a href="<?=base_url('/third-party/setup-vendor') ?>">Setup Vendor</a></li>
                                      <li><a href="<?=base_url('/third-party/manage-vendors') ?>">Manage Vendors</a></li>
                                    </ul>
