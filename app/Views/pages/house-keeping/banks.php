					...
					<thead>
                        ...
                        <?php $i = 1; foreach($banks as $bank) : ?>
                            <tr>
                                ...
                                <td> 
                                    <a href="javascript:void(0);" class="editBank" data-target="#editBankModal_<?= $bank['bank_id'] ?>" data-bank="<?= $bank['bank_name']  ?>" data-bankid="<?= $bank['bank_id']  ?>" data-toggle="modal"> Edit</a>
                                  <div class="modal fade" id="editBankModal_<?= $bank['bank_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form id="editLocationForm" method="post" action="<?= site_url('/update-bank') ?>">
                                            <div class="form-group">
                                              <label for="">Bank Name</label>
                                              <input type="text"  class="form-control" value="<?= $bank['bank_name'] ?>" name="bank_name"  placeholder="Bank Name">
                                              <input type="hidden" name="bankId" id="bankId" value="<?= $bank['bank_id'] ?>">
                                            </div>
                                            <div class="form-group">
                                              <label for="">Sort Code</label>
                                              <input type="text"  class="form-control" value="<?= $bank['sort_code'] ?>" name="sort_code"  placeholder="Sort Code">
                                            </div>
