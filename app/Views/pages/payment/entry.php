                          ...
                          <div class="row">
                            <div class="col-md-4">
                              <div class="form-group">
                                ...
                                <select name="source" id="source" class="form-control">
                                  ...
                                  <option value="2">From Vendor list</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-4 vendor-list">
                              <div class="form-group">
                                <label for=""> Vendor</label>
                                <select required name="vendor" id="vendor" class="form-control js-example-basic-single">
                                  <option selected disabled>--Select vendor --</option>
                                  <?php foreach($vendors as $vendor) : ?>
                                    <option value="<?= $vendor->vendor_id ?>"><?= $vendor->v_company_name ?? '' ?></option>
                                  <?php endforeach; ?>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-4 new-payee">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 new-payee">
                                <div class="form-group">
                                    ...
                                    <select  name="payee_bank" id="payee_bank" class="form-control js-example-basic-single">
                            ...
                            <div class="col-md-4 new-payee">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="bank_account_no" id="bank_account_no" placeholder="Bank Account No." class=" form-control">
                                </div>
                            </div>
                            <div class="col-md-4 new-payee">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 new-payee">
                                <div class="form-group">
                                  ...
                                  <select  name="gl_account" id="gl_account" class="form-control js-example-basic-single">
                                    <option selected disabled>--Select --</option>
...
$(document).ready(function(){
     ...
     $('#source').on('change',function(){
       if($(this).val() === 1){
         $('#thirdPartyPaymentEntryForm').parsley().destroy();
         $('#payee_name').attr('data-parsley-required', 'true');
         $('#payee_bank').attr('data-parsley-required', 'true');
         $('#bank_account_no').attr('data-parsley-required', 'true');
         $('#sort_code').attr('data-parsley-required', 'true');
         $('#gl_account').attr('data-parsley-required', 'true');
         $('#vendor').attr('data-parsley-required', 'false');
         $('#thirdPartyPaymentEntryForm').parsley();
         $('.new-payee').show();
         $('.vendor-list').hide();
       }else{
         $('#thirdPartyPaymentEntryForm').parsley().destroy();
         $('#payee_name').attr('data-parsley-required', 'false');
         $('#payee_bank').attr('data-parsley-required', 'false');
         $('#bank_account_no').attr('data-parsley-required', 'false');
         $('#sort_code').attr('data-parsley-required', 'false');
         $('#gl_account').attr('data-parsley-required', 'false');
         $('#vendor').attr('data-parsley-required', 'true');
         $('#thirdPartyPaymentEntryForm').parsley();
         $('.new-payee').hide();
         $('.vendor-list').show();
       }
